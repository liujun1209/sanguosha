...
namespace sgs {
    namespace package {
        ...
        bool Slash::isAvailable(const boost::shared_ptr<Player> player) const{
            return  BasicCard::isAvailable(player) || (player->hasWeapon(::CARD_NAME_ZHUGELIANNU) || player->hasSkill(""));
        }

        string Slash::getSubtype() const{
            return "attack_card";
        }
        void Slash::onUse(boost::shared_ptr<Room> room, const CardUseStruct &card_use) const {

        }
        void Slash::use(boost::shared_ptr<Room> room, boost::shared_ptr<ServerPlayer> source, vector<boost::shared_ptr<ServerPlayer> > &targets) const {
        }
        void Slash::onEffect(const CardEffectStruct &effect) const {
        }

        bool Slash::targetsFeasible(const vector<const boost::shared_ptr<Player> > &targets, const boost::shared_ptr<Player> Self) const {
            return false;
        }
        bool Slash::targetFilter(const vector<const boost::shared_ptr<Player> > &targets, const boost::shared_ptr<Player> to_select, const boost::shared_ptr<Player> Self) const {
            return false;
        }
        /*
        ...
        */
        void StandardPackage::addCards() {
            //…±
            cards_.push_back(boost::shared_ptr<Card>(new Slash(Card::Spade, 7)));
            cards_.push_back(boost::shared_ptr<Card>(new Slash(Card::Spade, 8)));
            cards_.push_back(boost::shared_ptr<Card>(new Slash(Card::Spade, 8)));
            cards_.push_back(boost::shared_ptr<Card>(new Slash(Card::Spade, 9)));
            cards_.push_back(boost::shared_ptr<Card>(new Slash(Card::Spade, 9)));
            cards_.push_back(boost::shared_ptr<Card>(new Slash(Card::Spade, 10)));
            cards_.push_back(boost::shared_ptr<Card>(new Slash(Card::Spade, 10)));

            cards_.push_back(boost::shared_ptr<Card>(new Slash(Card::Club, 2)));
            cards_.push_back(boost::shared_ptr<Card>(new Slash(Card::Club, 3)));
            cards_.push_back(boost::shared_ptr<Card>(new Slash(Card::Club, 4)));
            cards_.push_back(boost::shared_ptr<Card>(new Slash(Card::Club, 5)));
            cards_.push_back(boost::shared_ptr<Card>(new Slash(Card::Club, 6)));
            cards_.push_back(boost::shared_ptr<Card>(new Slash(Card::Club, 7)));
            cards_.push_back(boost::shared_ptr<Card>(new Slash(Card::Club, 8)));
            cards_.push_back(boost::shared_ptr<Card>(new Slash(Card::Club, 8)));
            cards_.push_back(boost::shared_ptr<Card>(new Slash(Card::Club, 9)));
            cards_.push_back(boost::shared_ptr<Card>(new Slash(Card::Club, 9)));
            cards_.push_back(boost::shared_ptr<Card>(new Slash(Card::Club, 10)));
            cards_.push_back(boost::shared_ptr<Card>(new Slash(Card::Club, 10)));
            cards_.push_back(boost::shared_ptr<Card>(new Slash(Card::Club, 11)));
            cards_.push_back(boost::shared_ptr<Card>(new Slash(Card::Club, 11)));
            
            cards_.push_back(boost::shared_ptr<Card>(new Slash(Card::Heart, 10)));
            cards_.push_back(boost::shared_ptr<Card>(new Slash(Card::Heart, 10)));
            cards_.push_back(boost::shared_ptr<Card>(new Slash(Card::Heart, 11)));
            
            cards_.push_back(boost::shared_ptr<Card>(new Slash(Card::Diamond, 6)));
            cards_.push_back(boost::shared_ptr<Card>(new Slash(Card::Diamond, 7)));
            cards_.push_back(boost::shared_ptr<Card>(new Slash(Card::Diamond, 8)));
            cards_.push_back(boost::shared_ptr<Card>(new Slash(Card::Diamond, 9)));
            cards_.push_back(boost::shared_ptr<Card>(new Slash(Card::Diamond, 10)));
            cards_.push_back(boost::shared_ptr<Card>(new Slash(Card::Diamond, 13)));
            /*
            //…¡
            cards_.push_back(boost::shared_ptr<Card>(new Jink(Card::Heart, 2)));
            cards_.push_back(boost::shared_ptr<Card>(new Jink(Card::Heart, 2)));
            cards_.push_back(boost::shared_ptr<Card>(new Jink(Card::Heart, 13)));
             
            
            cards_.push_back(boost::shared_ptr<Card>(new Jink(Card::Diamond, 2)));
            cards_.push_back(boost::shared_ptr<Card>(new Jink(Card::Diamond, 2)));
            cards_.push_back(boost::shared_ptr<Card>(new Jink(Card::Diamond, 3)));
            cards_.push_back(boost::shared_ptr<Card>(new Jink(Card::Diamond, 4)));
            cards_.push_back(boost::shared_ptr<Card>(new Jink(Card::Diamond, 5)));
            cards_.push_back(boost::shared_ptr<Card>(new Jink(Card::Diamond, 6)));
            cards_.push_back(boost::shared_ptr<Card>(new Jink(Card::Diamond, 7)));
            cards_.push_back(boost::shared_ptr<Card>(new Jink(Card::Diamond, 8)));
            cards_.push_back(boost::shared_ptr<Card>(new Jink(Card::Diamond, 9)));
            cards_.push_back(boost::shared_ptr<Card>(new Jink(Card::Diamond, 10)));
            cards_.push_back(boost::shared_ptr<Card>(new Jink(Card::Diamond, 11)));
            cards_.push_back(boost::shared_ptr<Card>(new Jink(Card::Diamond, 11)));
        
            //Ã“
            cards_.push_back(boost::shared_ptr<Card>(new Peach(Card::Heart, 3)));
            cards_.push_back(boost::shared_ptr<Card>(new Peach(Card::Heart, 4)));
            cards_.push_back(boost::shared_ptr<Card>(new Peach(Card::Heart, 6)));
            cards_.push_back(boost::shared_ptr<Card>(new Peach(Card::Heart, 7)));
            cards_.push_back(boost::shared_ptr<Card>(new Peach(Card::Heart, 8)));
            cards_.push_back(boost::shared_ptr<Card>(new Peach(Card::Heart, 9)));
            cards_.push_back(boost::shared_ptr<Card>(new Peach(Card::Heart, 12)));

            cards_.push_back(boost::shared_ptr<Card>(new Peach(Card::Diamond, 12)));
            */
            //Œ‰∆˜
